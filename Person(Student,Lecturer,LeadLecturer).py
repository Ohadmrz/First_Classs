...
class Person:                                                                                                           # Base class / parent class      Person:
...
class Student(Person):                                                                                                  # Derived / child class      Student(Person):
...
class Lecturer(Person):                                                                                                 # Derived / child class      Lecturer(Person):
...
class LeadLecturer(Lecturer):                                                                                           # Derived / child class      LeadLecturer(Lecturer)
