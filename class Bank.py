...
class Customer:
    ...
    def __repr__(self):
        return f"{self.__customer_id},{self.__name}"
...
if __name__ == '__main__':
    # address = Address("israel", "tel aviv", "dizingomski", 1212, 4)
    # biranecher = Branch(410, "Poalimski", address)
    # print(f"biranesher: {biranecher}")
    bank_company = Bank("Didney_conglomorat_Bank", Address("Israel", "Tel Adviv", "Allenby", 12345, 6))

    bank_company.add_branch(300, "discount", Address("Israel", "Tel Aviv", "Dizengoff", 12345, 6))
    bank_company.add_branch(414, "Poalim", Address("Israel", "Tel Aviv", "Hamasger", 67605, 54))
    bank_company.add_branch(410, "Poalim", Address("Israel", "Shoham", "Emek Ayalon", 56798, 2))
    bank_company.add_branch(413, "Poalim", Address("Israel", "Tel Aviv", "Allenby", 12345, 6))
    ...
    for br in branches:                                        # br: <Branch id: 300, name: discount>
        if br.get_branch_name() == "Poalim":
